...
export default function PainPoints() {
  return (
    <section className="relative py-24 px-4 bg-[#faf8f5]">
      {/* Decorative top wave */}
      <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-[#2d2420] to-transparent" />
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-light text-[#2d2420] mb-4 mt-12">
        ...
        >
          <div className="inline-block p-8 rounded-3xl bg-gradient-to-br from-[#2d2420] to-[#1a1614]">
